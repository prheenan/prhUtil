...
// For version 6.1
// I'm trying to improve the accuracy of the "molecule" trigger by using the new 
// "filtered" clone version of the deflection channel for the initial force ramp.   
  	...
  	SetDimLabel 0,4, $"Center X", CFPSettings
   	SetDimLabel 0,5, $"Center Y", CFPSettings
    	SetDimLabel 0,6, $"Critical Fit Difference", CFPSettings
      	...
      	SetDimLabel 0,13,$"FoundMolecule", CFPSettings
      	
      	CFPSettings={0,5,150e-9,0,0,0,10e-9,0,30e-12,150e-9,0,0,1,0}
...
Function CFP_MainLoop()
	...
	Strswitch (Centering[%State])
		case "FirstRamp":
			...
			DoForceRampFiltered(FirstRamp_Settings,FirstRamp_WaveNames,100)
...
Window CFP_Panel() : Panel
	...
	NewPanel /W=(1178,114,1442,758) as "Centered Force Pull"
	...
	SetVariable ApproachVelocity2,pos={84,95},size={160,16},disable=1,title="Approach Velocity"
	...
	PopupMenu InfoDisplay,pos={12,577},size={161,22},proc=CFPInfoDisplay,title="Display Info"
	PopupMenu InfoDisplay,mode=3,popvalue="CircleSettings",value= #"\"FirstRampTable;CenteringTable;CircleSettings;FineCenteringSettings;XYVoltage;XYSensor;XYSensor_nm;XCenteringFit;YCenteringFit;DefVsZSensor;ForceVsExt;XYZD_Targets;ZSensorGraph\""
	...
	PopupMenu QuickSettings,pos={11,612},size={181,22},proc=CFPQuickSettingsMenu,title="Quick Settings"
	PopupMenu QuickSettings,mode=3,popvalue="B12Riboswitch",value= #"\"650nmDNA;100nmDNA;B12Riboswitch\""
EndMacro
...
Function CFPQuickSettingsMenu(pa) : PopupMenuControl
	...
	switch( pa.eventCode )
		case 2: // mouse up
			...
			strswitch(popStr)
				case "650nmDNA":
					FirstRamp_Settings[%$"Surface Trigger"]=75e-12
					FirstRamp_Settings[%$"Molecule Trigger"]=40e-12
					FirstRamp_Settings[%$"Approach Velocity"]=1e-6
					FirstRamp_Settings[%$"Retract Velocity"]=1e-6
					FirstRamp_Settings[%$"Surface Dwell Time"]=2
					FirstRamp_Settings[%$"No Trigger Distance"]=150e-9
					FirstRamp_Settings[%$"Extension Distance"]=1e-6
					FirstRamp_Settings[%$"Sampling Rate"]=1000

					CenteredRamp_Settings[%$"Surface Trigger"]=75e-12
					CenteredRamp_Settings[%$"Approach Velocity"]=2e-6
					CenteredRamp_Settings[%$"Retract Velocity"]=1e-6
					CenteredRamp_Settings[%$"Surface Dwell Time"]=0
					CenteredRamp_Settings[%$"Extension Distance"]=1.4e-6
					CenteredRamp_Settings[%$"Sampling Rate"]=50000

					CFPSettings[%$"Distance to move from center"]=150e-9
					CFPSettings[%$"CircleRadius"]=150e-9
					CFPSettings[%$"Max Iterations"]=5
					CFPSettings[%$"Critical Fit Difference"]=10e-9
					CFPSettings[%$"TargetForce"]=30e-12
				...
				case "100nmDNA":
					...
					FirstRamp_Settings[%$"Retract Velocity"]=1e-6
					FirstRamp_Settings[%$"Surface Dwell Time"]=2
					FirstRamp_Settings[%$"No Trigger Distance"]=50e-9
					FirstRamp_Settings[%$"Extension Distance"]=175e-9
					FirstRamp_Settings[%$"Sampling Rate"]=1000
					...
					CenteredRamp_Settings[%$"Retract Velocity"]=1e-6
					CenteredRamp_Settings[%$"Surface Dwell Time"]=0
					CenteredRamp_Settings[%$"Extension Distance"]=250e-9
					CenteredRamp_Settings[%$"Sampling Rate"]=50000

					CFPSettings[%$"Distance to move from center"]=25e-9
					CFPSettings[%$"CircleRadius"]=25e-9
					CFPSettings[%$"Max Iterations"]=5
					CFPSettings[%$"Critical Fit Difference"]=10e-9
					CFPSettings[%$"TargetForce"]=30e-12
				...
				case "B12Riboswitch":
					FirstRamp_Settings[%$"Surface Trigger"]=75e-12
					FirstRamp_Settings[%$"Molecule Trigger"]=40e-12
					FirstRamp_Settings[%$"Approach Velocity"]=100e-9
					FirstRamp_Settings[%$"Retract Velocity"]=50e-9
					FirstRamp_Settings[%$"Surface Dwell Time"]=2
					FirstRamp_Settings[%$"No Trigger Distance"]=30e-9
					FirstRamp_Settings[%$"Extension Distance"]=100e-9
					FirstRamp_Settings[%$"Sampling Rate"]=1000

					CenteredRamp_Settings[%$"Surface Trigger"]=75e-12
					CenteredRamp_Settings[%$"Approach Velocity"]=100e-9
					CenteredRamp_Settings[%$"Retract Velocity"]=5e-9
					CenteredRamp_Settings[%$"Surface Dwell Time"]=0
					CenteredRamp_Settings[%$"Extension Distance"]=100e-9
					CenteredRamp_Settings[%$"Sampling Rate"]=50000

					CFPSettings[%$"Distance to move from center"]=20e-9
					CFPSettings[%$"CircleRadius"]=20e-9
					CFPSettings[%$"Max Iterations"]=5
					CFPSettings[%$"Critical Fit Difference"]=10e-9
					CFPSettings[%$"TargetForce"]=30e-12
