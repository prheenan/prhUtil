...
Function InitSearch([ShowUserInterface])
	...
	// Centering Settings
	Make/N=21/O root:SearchGrid:SearchSettings
	Wave SearchSettings=root:SearchGrid:SearchSettings
 	SetDimLabel 0,0, $"CoarseNumX", SearchSettings
 	SetDimLabel 0,1, $"CoarseNumY", SearchSettings
 	SetDimLabel 0,2, $"CoarseDistX", SearchSettings
 	SetDimLabel 0,3, $"CoarseDistY", SearchSettings
  	SetDimLabel 0,4, $"FineNumX", SearchSettings
   	SetDimLabel 0,5, $"FineNumY", SearchSettings
    	SetDimLabel 0,6, $"FineDistX", SearchSettings
      	SetDimLabel 0,7, $"FineDistY", SearchSettings
      	SetDimLabel 0,8, $"CoarseIterationsPerSpot", SearchSettings
      	SetDimLabel 0,9,$"FineIterationsPerSpot", SearchSettings
      	SetDimLabel 0,10,$"LastGoodIteration", SearchSettings
      	SetDimLabel 0,11,$"MasterIteration", SearchSettings
      	SetDimLabel 0,12,$"MapNumber", SearchSettings
      	SetDimLabel 0,13,$"FineLevel",SearchSettings
      	SetDimLabel 0,14,$"IterationsAtCurrentSpot",SearchSettings
      	SetDimLabel 0,15,$"SpotNumber",SearchSettings
      	SetDimLabel 0,16,$"CoarseSpotNumber",SearchSettings
      	SetDimLabel 0,17,$"FineSpotNumber",SearchSettings
      	SetDimLabel 0,18,$"UseFineSearch",SearchSettings
      	SetDimLabel 0,19,$"IterationsAtHotSpot",SearchSettings
      	SetDimLabel 0,20,$"HotSpotManualOverride",SearchSettings
      	
      	SearchSettings={5,5,50e-9,50e-9,5,5,10e-9,10e-9,10,2,0,0,0,0,0,0,0,0,1,20,0}
...
Function ShowSearchInfo(SelectedDisplay)
	...
	strswitch(SelectedDisplay)
		case "SearchGrids":
			...
			If(!V_flag)
				Display/N=SearchGridDisplay FineGridY vs FineGridX 
...
Window Search_Panel() : Panel
	...
	NewPanel /W=(1592,263,1875,865) as "SearchForMolecule"
