...
Function InitRNAPulling()
	...
	RNAPullingStrSettings={"RNAPullingCallback()","Waiting","root:RNAPulling:DefV","root:RNAPulling:ZSensor","root:RNAPulling:ZSetPoint","NearestForcePull"}
...
Function DoClosedLoopZMotion(ZSensorSetPoint,Deflection,ZSensor,[DecimationFactor,Callback])
	...
	String Callback
	Variable Error	
	ReSample/Down=100 ZSensorSetPoint
	...
	// Setup motion
	Error += td_xSetOutWave(0, "0,0", "PIDSLoop.2.Setpoint", ZSensorSetPoint,100)
...
Function DoRNAPull(OperationMode,RNAPullingSettings,RNAPullingStrSettings)
	...
	EndSwitch
	 ...
	 // Negative to make wave move away from surface
	...
	FastOp ZSensorSetPoint=(ZLVDTSens)*ZSensorSetPointTemp+(CurrentPosition)
